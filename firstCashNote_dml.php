...
function firstCashNote_insert(){
	...
	sql('insert into `firstCashNote` set       `order`=' . (($data['order'] !== '' && $data['order'] !== NULL) ? "'{$data['order']}'" : 'NULL') . ', `operationDate`=' . (($data['operationDate'] !== '' && $data['operationDate'] !== NULL) ? "'{$data['operationDate']}'" : 'NULL') . ', `documentNumber`=' . (($data['documentNumber'] !== '' && $data['documentNumber'] !== NULL) ? "'{$data['documentNumber']}'" : 'NULL') . ', `causal`=' . (($data['causal'] !== '' && $data['causal'] !== NULL) ? "'{$data['causal']}'" : 'NULL') . ', `revenue`=' . (($data['revenue'] !== '' && $data['revenue'] !== NULL) ? "'{$data['revenue']}'" : 'NULL') . ', `outputs`=' . (($data['outputs'] !== '' && $data['outputs'] !== NULL) ? "'{$data['outputs']}'" : 'NULL') . ', `balance`=' . (($data['balance'] !== '' && $data['balance'] !== NULL) ? "'{$data['balance']}'" : 'NULL') . ', `idBank`=' . (($data['idBank'] !== '' && $data['idBank'] !== NULL) ? "'{$data['idBank']}'" : 'NULL') . ', `bank`=' . (($data['bank'] !== '' && $data['bank'] !== NULL) ? "'{$data['bank']}'" : 'NULL') . ', `note`=' . (($data['note'] !== '' && $data['note'] !== NULL) ? "'{$data['note']}'" : 'NULL') . ', `paymentDeadLine`=' . (($data['paymentDeadLine'] !== '' && $data['paymentDeadLine'] !== NULL) ? "'{$data['paymentDeadLine']}'" : 'NULL') . ', `payed`=' . (($data['payed'] !== '' && $data['payed'] !== NULL) ? "'{$data['payed']}'" : 'NULL'), $o);
	if($o['error']!=''){
		echo $o['error'];
...
function firstCashNote_update($selected_id){
	...
	$o=array('silentErrors' => true);
	sql('update `firstCashNote` set       `order`=' . (($data['order'] !== '' && $data['order'] !== NULL) ? "'{$data['order']}'" : 'NULL') . ', `operationDate`=' . (($data['operationDate'] !== '' && $data['operationDate'] !== NULL) ? "'{$data['operationDate']}'" : 'NULL') . ', `documentNumber`=' . (($data['documentNumber'] !== '' && $data['documentNumber'] !== NULL) ? "'{$data['documentNumber']}'" : 'NULL') . ', `causal`=' . (($data['causal'] !== '' && $data['causal'] !== NULL) ? "'{$data['causal']}'" : 'NULL') . ', `revenue`=' . (($data['revenue'] !== '' && $data['revenue'] !== NULL) ? "'{$data['revenue']}'" : 'NULL') . ', `outputs`=' . (($data['outputs'] !== '' && $data['outputs'] !== NULL) ? "'{$data['outputs']}'" : 'NULL') . ', `balance`=' . (($data['balance'] !== '' && $data['balance'] !== NULL) ? "'{$data['balance']}'" : 'NULL') . ', `idBank`=' . (($data['idBank'] !== '' && $data['idBank'] !== NULL) ? "'{$data['idBank']}'" : 'NULL') . ', `bank`=' . (($data['bank'] !== '' && $data['bank'] !== NULL) ? "'{$data['bank']}'" : 'NULL') . ', `note`=' . (($data['note'] !== '' && $data['note'] !== NULL) ? "'{$data['note']}'" : 'NULL') . ', `paymentDeadLine`=' . (($data['paymentDeadLine'] !== '' && $data['paymentDeadLine'] !== NULL) ? "'{$data['paymentDeadLine']}'" : 'NULL') . ', `payed`=' . (($data['payed'] !== '' && $data['payed'] !== NULL) ? "'{$data['payed']}'" : 'NULL') . " where `id`='".makeSafe($selected_id)."'", $o);
	if($o['error']!=''){
		echo $o['error'];
...
function firstCashNote_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = ''){
	...
	if($selected_id){
		...
		if($AllowUpdate){
			$templateCode = str_replace('<%%UPDATE_BUTTON%%>', '<button type="submit" class="btn btn-success " id="update" name="update_x" value="1" onclick="return firstCashNote_validateData();" title="' . html_attr($Translation['Save Changes']) . '"><i class="glyphicon glyphicon-ok"></i> ' . $Translation['Save Changes'] . '</button>', $templateCode);
		}else{
	...
	if(($selected_id && !$AllowUpdate && !$AllowInsert) || (!$selected_id && !$AllowInsert)){
		...
		$jsReadOnly .= "\tjQuery('#idBank').replaceWith('<div class=\"form-control-static\" id=\"idBank\">' + (jQuery('#idBank').val() || '') + '</div>');\n";
