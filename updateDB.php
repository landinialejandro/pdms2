<?php
	...
	if($thisMD5==$prevMD5){
		...
		setupTable('phones', "create table if not exists `phones` (   `id` INT unsigned not null auto_increment , primary key (`id`), `kind` VARCHAR(40) null , `phoneNumber` VARCHAR(255) null , `contact` INT unsigned null , `company` INT unsigned null , `default` VARCHAR(40) null default '0' ) CHARSET utf8", $silent);
		setupIndexes('phones', array('kind','contact','company'));
		setupTable('mails', "create table if not exists `mails` (   `id` INT unsigned not null auto_increment , primary key (`id`), `kind` VARCHAR(40) null , `mail` VARCHAR(255) null , `contact` INT unsigned null , `company` INT unsigned null , `default` VARCHAR(40) null default '0' ) CHARSET utf8", $silent);
