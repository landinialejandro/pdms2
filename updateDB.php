<?php
	...
	if($thisMD5==$prevMD5){
		...
		// set up tables
		setupTable('orders', "create table if not exists `orders` (   `id` INT unsigned not null auto_increment , primary key (`id`), `kind` VARCHAR(40) , `progressiveNr` CHAR(40) , `trasmissionFor` CHAR(10) default 'SDI10' , `consigneeID` CHAR(10) , `company` INT unsigned , `typeDoc` VARCHAR(40) , `multiOrder` INT , `customer` INT unsigned , `employee` INT unsigned , `date` DATE , `requiredDate` DATE , `shippedDate` DATE , `shipVia` INT unsigned , `Freight` DECIMAL(10,2) , `pallets` INT , `licencePlate` VARCHAR(40) , `orderTotal` DECIMAL(10,2) , `cashCredit` VARCHAR(255) default '1' , `trust` INT unsigned , `overdraft` INT , `commisionFee` INT , `consigneeHour` DATETIME , `consigneePlace` VARCHAR(255) , `related` INT ) CHARSET utf8", $silent, array( "ALTER TABLE orders ADD `field25` VARCHAR(40)","ALTER TABLE `orders` CHANGE `field25` `related` VARCHAR(40) "," ALTER TABLE `orders` CHANGE `related` `related` INT "));
