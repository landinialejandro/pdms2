<?php
	...
	if($thisMD5==$prevMD5){
		...
		setupTable('phones', "create table if not exists `phones` (   `id` INT unsigned not null auto_increment , primary key (`id`), `kind` VARCHAR(40) null , `phoneNumber` VARCHAR(255) null , `contact` INT unsigned null , `company` INT unsigned null , `default` VARCHAR(40) null default '0' ) CHARSET utf8", $silent, array( "ALTER TABLE phones ADD `field6` VARCHAR(40)","ALTER TABLE `phones` CHANGE `field6` `default` VARCHAR(40) null "," ALTER TABLE `phones` CHANGE `default` `default` VARCHAR(40) null default '0' "));
		setupIndexes('phones', array('kind','contact','company'));
		setupTable('mails', "create table if not exists `mails` (   `id` INT unsigned not null auto_increment , primary key (`id`), `kind` VARCHAR(40) null , `mail` VARCHAR(255) null , `contact` INT unsigned null , `company` INT unsigned null , `default` VARCHAR(40) null default '0' ) CHARSET utf8", $silent, array( "ALTER TABLE mails ADD `field6` VARCHAR(40)","ALTER TABLE `mails` CHANGE `field6` `default` VARCHAR(40) null "," ALTER TABLE `mails` CHANGE `default` `default` VARCHAR(40) null default '0' "));
