<?php
	...
	if($thisMD5==$prevMD5){
		...
		// set up tables
		setupTable('orders', "create table if not exists `orders` (   `id` INT unsigned not null auto_increment , primary key (`id`), `kind` VARCHAR(40) not null , `company` INT unsigned not null , `typeDoc` VARCHAR(40) not null , `multiOrder` INT not null , `divisa` CHAR(3) not null default 'EUR' , `causale` VARCHAR(200) not null default 'VENDITA' , `customer` INT unsigned null , `supplier` INT unsigned null , `employee` INT unsigned null , `date` DATE null , `dateRequired` DATE null , `dateShipped` DATE null , `shipVia` INT unsigned null , `Freight` DECIMAL(10,2) null , `pallets` INT null , `licencePlate` VARCHAR(255) null , `importoSconto` VARCHAR(40) null , `orderTotal` DECIMAL(10,2) not null , `RIT_importoRitenuta` VARCHAR(40) null , `cashCredit` VARCHAR(255) null default '1' , `trust` INT unsigned null , `overdraft` INT null , `commisionFee` DECIMAL(10,2) null , `commisionRate` DECIMAL(10,2) null , `consigneeHour` DATETIME null , `consigneePlace` VARCHAR(255) null , `related` INT null , `document` VARCHAR(255) null ) CHARSET utf8", $silent);
		...
		setupTable('companies', "create table if not exists `companies` (   `id` INT unsigned not null auto_increment , primary key (`id`), `kind` VARCHAR(40) not null , `companyCode` VARCHAR(255) null , unique `companyCode_unique` (`companyCode`), `companyName` VARCHAR(255) null , `personaFisica` VARCHAR(40) not null default 'No' , `fiscalCode` VARCHAR(255) null , `vat` VARCHAR(255) not null , `notes` TEXT null , `codiceDestinatario` VARCHAR(7) null default '0000000' , `regimeFiscale` VARCHAR(40) null , `tipoCassa` VARCHAR(40) null , `modalitaPagamento` VARCHAR(40) null , `RiferimentoAmministrazione` VARCHAR(40) null , `FormatoTrasmissione` VARCHAR(40) not null default 'FPR12' , `RIT_soggettoRitenuta` TINYINT null default '0' , `RIT_tipoRitenuta` VARCHAR(40) not null default 'RT02' , `RIT_AliquotaRitenuta` DECIMAL(10,2) null , `RIT_CausalePagamento` VARCHAR(40) null , `IBAN` VARCHAR(40) null , `ABI` VARCHAR(40) null , `CAB` VARCHAR(40) null , `BIC` VARCHAR(40) null , `autorizzSanitaria_SAM` VARCHAR(255) null , `AutSanEmessa_SAM` VARCHAR(255) null , `NrPresSan_SAM` VARCHAR(255) null , `NrAutSan_SAM` VARCHAR(40) null , `dataAutSan_SAM` DATE null ) CHARSET utf8", $silent, array( "ALTER TABLE companies ADD `field23` VARCHAR(40)","ALTER TABLE `companies` CHANGE `field23` `autorizzSanitaria_SAM` VARCHAR(40) null ","ALTER TABLE companies ADD `field24` VARCHAR(40)","ALTER TABLE `companies` CHANGE `field24` `AutSanEmessa_SAM` VARCHAR(40) null ","ALTER TABLE companies ADD `field25` VARCHAR(40)","ALTER TABLE `companies` CHANGE `field25` `NrPresSan_SAM` VARCHAR(40) null ","ALTER TABLE companies ADD `field26` VARCHAR(40)","ALTER TABLE `companies` CHANGE `field26` `NrAutSan_SAM` VARCHAR(40) null ","ALTER TABLE companies ADD `field27` VARCHAR(40)","ALTER TABLE `companies` CHANGE `field27` `dataAutSan_SAM` VARCHAR(40) null "," ALTER TABLE `companies` CHANGE `autorizzSanitaria_SAM` `autorizzSanitaria_SAM` VARCHAR(255) null "," ALTER TABLE `companies` CHANGE `AutSanEmessa_SAM` `AutSanEmessa_SAM` VARCHAR(255) null "," ALTER TABLE `companies` CHANGE `NrPresSan_SAM` `NrPresSan_SAM` VARCHAR(255) null "," ALTER TABLE `companies` CHANGE `dataAutSan_SAM` `dataAutSan_SAM` DATE null "));
		...
		setupTable('town', "create table if not exists `town` (   `id` INT unsigned not null auto_increment , primary key (`id`), `country` INT unsigned null , `idIstat` VARCHAR(255) null , `town` VARCHAR(60) null , `district` CHAR(2) not null , `region` VARCHAR(255) null , `prefix` VARCHAR(255) null , `shipCode` VARCHAR(255) not null , `fiscCode` VARCHAR(255) null , `inhabitants` VARCHAR(255) null , `link` VARCHAR(255) null ) CHARSET utf8", $silent);
		...
		setupTable('addresses', "create table if not exists `addresses` (   `id` INT unsigned not null auto_increment , primary key (`id`), `kind` VARCHAR(40) null , `address` VARCHAR(255) not null , `houseNumber` VARCHAR(255) not null , `country` INT unsigned not null , `town` INT unsigned not null , `postalCode` CHAR(5) null , `district` INT unsigned null , `contact` INT unsigned null , `company` INT unsigned null , `map` VARCHAR(40) null , `default` INT null default '0' , `ship` INT null default '0' ) CHARSET utf8", $silent);
