<?php
	...
	if($thisMD5==$prevMD5){
		...
		setupTable('contacts', "create table if not exists `contacts` (   `id` INT unsigned not null auto_increment , primary key (`id`), `kind` VARCHAR(40) , `titleCourtesy` VARCHAR(40) , `name` VARCHAR(255) , `lastName` VARCHAR(255) , `notes` TEXT , `title` VARCHAR(255) , `birthDate` DATE , `CodEORI` VARCHAR(40) ) CHARSET utf8", $silent, array( "ALTER TABLE contacts ADD `field9` VARCHAR(40)","ALTER TABLE `contacts` CHANGE `field9` `code` VARCHAR(40) ","ALTER TABLE `contacts` CHANGE `code` `CodEORI` VARCHAR(40) "));
