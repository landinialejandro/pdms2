<?php
	...
	if($thisMD5==$prevMD5){
		...
		setupTable('addresses', "create table if not exists `addresses` (   `id` INT unsigned not null auto_increment , primary key (`id`), `kind` VARCHAR(40) , `address` VARCHAR(40) , `houseNumber` VARCHAR(40) , `country` INT unsigned , `town` INT unsigned , `postalCode` INT unsigned , `district` INT unsigned , `contact` INT unsigned , `company` INT unsigned , `map` VARCHAR(40) , `default` VARCHAR(40) default '0' , `ship` VARCHAR(40) default '0' ) CHARSET utf8", $silent, array( "ALTER TABLE addresses ADD `field12` VARCHAR(40)","ALTER TABLE `addresses` CHANGE `field12` `default` VARCHAR(40) "," ALTER TABLE `addresses` CHANGE `default` `default` VARCHAR(40) default '0' ","ALTER TABLE addresses ADD `field13` VARCHAR(40)","ALTER TABLE `addresses` CHANGE `field13` `ship` VARCHAR(40) "," ALTER TABLE `addresses` CHANGE `ship` `ship` VARCHAR(40) default '0' "));
