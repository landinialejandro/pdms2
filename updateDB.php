<?php
	...
	if($thisMD5==$prevMD5){
		...
		setupTable('firstCashNote', "create table if not exists `firstCashNote` (   `id` INT unsigned not null auto_increment , primary key (`id`), `kind` VARCHAR(40) not null , `order` INT unsigned , `operationDate` DATE , `company` INT unsigned , `customer` INT unsigned , `documentNumber` INT , `causal` VARCHAR(255) , `revenue` DECIMAL(10,2) , `outputs` DECIMAL(10,2) , `balance` DECIMAL(10,2) , `idBank` INT unsigned , `bank` INT unsigned , `note` VARCHAR(255) , `paymentDeadLine` DATE , `payed` VARCHAR(255) default '0' ) CHARSET utf8", $silent);
		...
		setupTable('countries', "create table if not exists `countries` (   `id` INT unsigned not null auto_increment , primary key (`id`), `country` VARCHAR(255) , `code` VARCHAR(100) , `ISOcode` VARCHAR(40) ) CHARSET utf8", $silent);
		...
		setupTable('addresses', "create table if not exists `addresses` (   `id` INT unsigned not null auto_increment , primary key (`id`), `kind` VARCHAR(40) , `address` VARCHAR(255) , `houseNumber` VARCHAR(255) , `country` INT unsigned , `country_name` INT unsigned , `town` INT unsigned , `postalCode` INT unsigned , `district` INT unsigned , `contact` INT unsigned , `company` INT unsigned , `map` VARCHAR(40) , `default` INT default '0' , `ship` INT default '0' ) CHARSET utf8", $silent, array( " ALTER TABLE `addresses` CHANGE `country` `country` INT unsigned ","ALTER TABLE addresses ADD `field14` VARCHAR(40)","ALTER TABLE `addresses` CHANGE `field14` `country_name` VARCHAR(40) "));
		...
		setupTable('contacts_companies', "create table if not exists `contacts_companies` (   `id` INT unsigned not null auto_increment , primary key (`id`), `contact` INT unsigned , `company` INT unsigned , `default` VARCHAR(40) default '0' ) CHARSET utf8", $silent);
