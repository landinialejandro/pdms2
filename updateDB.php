<?php
	...
	if($thisMD5==$prevMD5){
		...
		setupTable('_ordersSummary', "create table if not exists `_ordersSummary` (   `kind` VARCHAR(40) null , `company` INT unsigned null , `typedoc` VARCHAR(40) null , `customer` INT unsigned null , `TOT` VARCHAR(40) null , `MONTH` VARCHAR(40) null , `YEAR` VARCHAR(40) null , `DOCs` VARCHAR(40) null , `related` INT unsigned null , `id` INT unsigned not null auto_increment , primary key (`id`)) CHARSET utf8", $silent, array( "ALTER TABLE `_resumeOrders` RENAME `_ordersSummary`","UPDATE `membership_userrecords` SET `tableName`='_ordersSummary' where `tableName`='_resumeOrders'","UPDATE `membership_userpermissions` SET `tableName`='_ordersSummary' where `tableName`='_resumeOrders'","UPDATE `membership_grouppermissions` SET `tableName`='_ordersSummary' where `tableName`='_resumeOrders'"));
