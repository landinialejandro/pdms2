<?php
	...
	if($thisMD5==$prevMD5){
		...
		// set up tables
		setupTable('orders', "create table if not exists `orders` (   `id` INT unsigned not null auto_increment , primary key (`id`), `kind` VARCHAR(40) not null , `company` INT unsigned not null , `typeDoc` VARCHAR(40) not null , `multiOrder` INT not null , `divisa` CHAR(3) not null default 'EUR' , `causale` VARCHAR(200) not null default 'VENDITA' , `customer` INT unsigned null , `supplier` INT unsigned null , `employee` VARCHAR(100) null , `date` DATE null , `dateRequired` DATE null , `dateShipped` DATE null , `shipVia` INT unsigned null , `Freight` DECIMAL(10,2) null , `pallets` INT null , `licencePlate` VARCHAR(255) null , `importoSconto` VARCHAR(40) null , `orderTotal` DECIMAL(10,2) not null default '0' , `RIT_importoRitenuta` VARCHAR(40) null , `cashCredit` VARCHAR(255) null default '1' , `trust` INT unsigned null , `overdraft` INT null , `commisionFee` DECIMAL(10,2) null , `commisionRate` DECIMAL(10,2) null , `consigneeHour` DATETIME null , `consigneePlace` VARCHAR(255) null , `related` INT null , `document` VARCHAR(255) null ) CHARSET utf8", $silent);
		setupIndexes('orders', array('kind','company','typeDoc','customer','supplier','shipVia'));
		setupTable('ordersDetails', "create table if not exists `ordersDetails` (   `id` INT unsigned not null auto_increment , primary key (`id`), `order` INT unsigned null , `manufactureDate` DATE null , `sellDate` DATE null , `expiryDate` DATE null , `daysToExpiry` INT null , `codebar` INT null , `UM` INT null , `productCode` INT null , `batch` INT null , `packages` DECIMAL(10,2) null , `noSell` INT null , `Quantity` DECIMAL(10,2) null default '1' , `QuantityReal` DECIMAL(10,2) null , `UnitPrice` DECIMAL(10,2) null , `Subtotal` DECIMAL(10,2) unsigned null , `taxes` DECIMAL(10,2) null , `Discount` DECIMAL(10,2) null , `LineTotal` DECIMAL(10,2) null , `section` VARCHAR(40) null default 'Magazzino Metaponto' , `transaction_type` INT unsigned null , `skBatches` INT unsigned null , `averagePrice` DECIMAL(10,2) null , `averageWeight` DECIMAL(10,2) null , `commission` DECIMAL(10,2) null default '15.00' , `return` VARCHAR(255) null default '1' , `supplierCode` VARCHAR(100) null , `related` INT null ) CHARSET utf8", $silent, array( "ALTER TABLE ordersDetails ADD `field28` VARCHAR(40)","ALTER TABLE `ordersDetails` CHANGE `field28` `related` VARCHAR(40) null "," ALTER TABLE `ordersDetails` CHANGE `related` `related` INT null "));
		setupIndexes('ordersDetails', array('order','productCode','section'));
		setupTable('_ordersSummary', "create table if not exists `_ordersSummary` (   `kind` VARCHAR(40) null , `company` INT unsigned null , `typedoc` VARCHAR(40) null , `customer` INT unsigned null , `TOT` VARCHAR(40) null , `MONTH` VARCHAR(40) null , `YEAR` VARCHAR(40) null , `DOCs` VARCHAR(40) null , `related` INT unsigned null , `id` INT unsigned not null auto_increment , primary key (`id`)) CHARSET utf8", $silent);
		setupIndexes('_ordersSummary', array('kind','company','typedoc','customer','related'));
