<?php
	...
	if($thisMD5==$prevMD5){
		...
		setupTable('firstCashNote', "create table if not exists `firstCashNote` (   `id` INT unsigned not null auto_increment , primary key (`id`), `kind` VARCHAR(40) , `order` INT unsigned , `operationDate` DATE , `company` INT unsigned , `customer` INT unsigned , `documentNumber` INT , `causal` VARCHAR(255) , `revenue` DECIMAL(10,2) , `outputs` DECIMAL(10,2) , `balance` DECIMAL(10,2) , `idBank` INT unsigned , `bank` INT unsigned , `note` VARCHAR(255) , `paymentDeadLine` DATE , `payed` VARCHAR(255) default '0' ) CHARSET utf8", $silent, array( "ALTER TABLE firstCashNote ADD `field16` VARCHAR(40)","ALTER TABLE `firstCashNote` CHANGE `field16` `kind` VARCHAR(40) "));
		...
		setupTable('companies', "create table if not exists `companies` (   `id` INT unsigned not null auto_increment , primary key (`id`), `kind` VARCHAR(40) not null , `companyCode` VARCHAR(255) , `companyName` VARCHAR(255) , `fiscalCode` VARCHAR(255) , `vat` VARCHAR(255) not null , `notes` TEXT ) CHARSET utf8", $silent);
		setupIndexes('companies', array('kind'));
		setupTable('contacts', "create table if not exists `contacts` (   `id` INT unsigned not null auto_increment , primary key (`id`), `kind` VARCHAR(40) , `titleCourtesy` VARCHAR(40) , `name` VARCHAR(255) , `lastName` VARCHAR(255) , `notes` TEXT , `title` VARCHAR(255) , `birthDate` DATE ) CHARSET utf8", $silent);
		...
		setupTable('countries', "create table if not exists `countries` (   `id` INT unsigned not null auto_increment , primary key (`id`), `country` VARCHAR(255) , `code` VARCHAR(100) ) CHARSET utf8", $silent);
		setupTable('town', "create table if not exists `town` (   `id` INT unsigned not null auto_increment , primary key (`id`), `country` INT unsigned , `idIstat` VARCHAR(255) , `town` VARCHAR(255) , `district` VARCHAR(255) , `region` VARCHAR(255) , `prefix` VARCHAR(255) , `shipCode` VARCHAR(255) , `fiscCode` VARCHAR(255) , `inhabitants` VARCHAR(255) , `link` VARCHAR(255) ) CHARSET utf8", $silent);
		...
		setupTable('phones', "create table if not exists `phones` (   `id` INT unsigned not null auto_increment , primary key (`id`), `kind` VARCHAR(40) , `phoneNumber` VARCHAR(255) , `contact` INT unsigned , `company` INT unsigned ) CHARSET utf8", $silent);
