<?php
	...
	if($thisMD5==$prevMD5){
		...
		setupTable('companies', "create table if not exists `companies` (   `id` INT unsigned not null auto_increment , primary key (`id`), `kind` VARCHAR(40) not null , `kind_code` VARCHAR(40) null , `companyCode` VARCHAR(255) null , unique `companyCode_unique` (`companyCode`), `companyName` VARCHAR(255) null , `fiscalCode` VARCHAR(255) null , `vat` VARCHAR(255) not null , `notes` TEXT null , `codiceDestinatario` VARCHAR(40) null , `regimeFiscale` VARCHAR(40) null , `tipoCassa` VARCHAR(40) null , `modalitaPagamento` VARCHAR(40) null , `RiferimentoAmministrazione` VARCHAR(40) null , `FormatoTrasmissione` VARCHAR(40) not null default 'FPR12' , `REA_Ufficio` VARCHAR(2) null , `REA_NumeroREA` VARCHAR(20) null , `REA_CapitaleSociale` VARCHAR(40) null , `REA_SocioUnico` VARCHAR(2) null default 'SU' , `REA_StatoLiquidazione` VARCHAR(2) null default 'LN' , `RIT_soggettoRitenuta` VARCHAR(40) null default '0' , `RIT_tipoRitenuta` VARCHAR(40) null default 'RT02' , `RIT_AliquotaRitenuta` DECIMAL(10,2) null , `RIT_CausalePagamento` VARCHAR(40) null ) CHARSET utf8", $silent, array( " ALTER TABLE `companies` CHANGE `RIT_soggettoRitenuta` `RIT_soggettoRitenuta` VARCHAR(40) null default '0' "));
