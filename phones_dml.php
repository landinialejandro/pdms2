...
function phones_insert(){
	...
	sql('insert into `phones` set       `kind`=' . (($data['kind'] !== '' && $data['kind'] !== NULL) ? "'{$data['kind']}'" : 'NULL') . ', `phoneNumber`=' . (($data['phoneNumber'] !== '' && $data['phoneNumber'] !== NULL) ? "'{$data['phoneNumber']}'" : 'NULL') . ', `default`=' . (($data['default'] !== '' && $data['default'] !== NULL) ? "'{$data['default']}'" : 'NULL'), $o);
	if($o['error']!=''){
		echo $o['error'];
...
function phones_update($selected_id){
	...
	$o=array('silentErrors' => true);
	sql('update `phones` set       `kind`=' . (($data['kind'] !== '' && $data['kind'] !== NULL) ? "'{$data['kind']}'" : 'NULL') . ', `phoneNumber`=' . (($data['phoneNumber'] !== '' && $data['phoneNumber'] !== NULL) ? "'{$data['phoneNumber']}'" : 'NULL') . ', `default`=' . (($data['default'] !== '' && $data['default'] !== NULL) ? "'{$data['default']}'" : 'NULL') . " where `id`='".makeSafe($selected_id)."'", $o);
	if($o['error']!=''){
		echo $o['error'];
