...
function ordersDetails_insert(){
	...
	sql('insert into `ordersDetails` set       `manufactureDate`=' . (($data['manufactureDate'] !== '' && $data['manufactureDate'] !== NULL) ? "'{$data['manufactureDate']}'" : 'NULL') . ', `sellDate`=' . (($data['sellDate'] !== '' && $data['sellDate'] !== NULL) ? "'{$data['sellDate']}'" : 'NULL') . ', `productCode`=' . (($data['productCode'] !== '' && $data['productCode'] !== NULL) ? "'{$data['productCode']}'" : 'NULL') . ', `packages`=' . (($data['packages'] !== '' && $data['packages'] !== NULL) ? "'{$data['packages']}'" : 'NULL') . ', `noSell`=' . (($data['noSell'] !== '' && $data['noSell'] !== NULL) ? "'{$data['noSell']}'" : 'NULL') . ', `Quantity`=' . (($data['Quantity'] !== '' && $data['Quantity'] !== NULL) ? "'{$data['Quantity']}'" : 'NULL') . ', `QuantityReal`=' . (($data['QuantityReal'] !== '' && $data['QuantityReal'] !== NULL) ? "'{$data['QuantityReal']}'" : 'NULL') . ', `UnitPrice`=' . (($data['UnitPrice'] !== '' && $data['UnitPrice'] !== NULL) ? "'{$data['UnitPrice']}'" : 'NULL') . ', `Subtotal`=' . (($data['Subtotal'] !== '' && $data['Subtotal'] !== NULL) ? "'{$data['Subtotal']}'" : 'NULL') . ', `Discount`=' . (($data['Discount'] !== '' && $data['Discount'] !== NULL) ? "'{$data['Discount']}'" : 'NULL') . ', `LineTotal`=' . (($data['LineTotal'] !== '' && $data['LineTotal'] !== NULL) ? "'{$data['LineTotal']}'" : 'NULL') . ', `averagePrice`=' . (($data['averagePrice'] !== '' && $data['averagePrice'] !== NULL) ? "'{$data['averagePrice']}'" : 'NULL') . ', `averageWeight`=' . (($data['averageWeight'] !== '' && $data['averageWeight'] !== NULL) ? "'{$data['averageWeight']}'" : 'NULL') . ', `commission`=' . (($data['commission'] !== '' && $data['commission'] !== NULL) ? "'{$data['commission']}'" : 'NULL') . ', `return`=' . (($data['return'] !== '' && $data['return'] !== NULL) ? "'{$data['return']}'" : 'NULL') . ', `supplierCode`=' . (($data['supplierCode'] !== '' && $data['supplierCode'] !== NULL) ? "'{$data['supplierCode']}'" : 'NULL'), $o);
	if($o['error']!=''){
		echo $o['error'];
...
function ordersDetails_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = ''){
	...
	if($selected_id){
		...
		if($AllowUpdate){
			$templateCode = str_replace('<%%UPDATE_BUTTON%%>', '<button type="submit" class="btn btn-success " id="update" name="update_x" value="1" onclick="return ordersDetails_validateData();" title="' . html_attr($Translation['Save Changes']) . '"><i class="glyphicon glyphicon-ok"></i> ' . $Translation['Save Changes'] . '</button>', $templateCode);
		}else{
