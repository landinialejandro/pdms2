...
<div class="page-header">
	...
	<h1>
		...
		<a href="output-folder.php?axp=<?php echo $axp_md5; ?>" class="pull-right btn btn-success  col-md-3 col-xs-12"><span class="glyphicon glyphicon-play"></span>  Create Search Pages</a>
	</h1>
