	...
	$lookups = array(   
		'orders' => array(   
			...
			'company' => array(
				...
				'parent_from' => '`companies` LEFT JOIN `kinds` as kinds1 ON `kinds1`.`code`=`companies`.`kind` LEFT JOIN `kinds` as kinds2 ON `kinds2`.`code`=`companies`.`regimeFiscale` LEFT JOIN `kinds` as kinds3 ON `kinds3`.`code`=`companies`.`tipoCassa` LEFT JOIN `kinds` as kinds4 ON `kinds4`.`code`=`companies`.`modalitaPagamento` ',
				'filterers' => array(),
		...
		'companies' => array(   
			...
			'regimeFiscale' => array(
				...
				'parent_from' => '`kinds` ',
				'filterers' => array(),
				'custom_query' => 'SELECT `kinds`.`code`, IF(CHAR_LENGTH(`kinds`.`code`) || CHAR_LENGTH(`kinds`.`name`), CONCAT_WS(\'\', `kinds`.`code`, \' - \', `kinds`.`name`), \'\') FROM `kinds` WHERE `kinds`.`entity` LIKE \'%sdi-RegimeFiscale%\' ORDER BY 2 ',
				'inherit_permissions' => false,
				'list_type' => 0,
				'not_null' => false
			),
			'tipoCassa' => array(
				...
				'parent_from' => '`kinds` ',
				'filterers' => array(),
				'custom_query' => 'SELECT `kinds`.`code`, IF(CHAR_LENGTH(`kinds`.`code`) || CHAR_LENGTH(`kinds`.`name`), CONCAT_WS(\'\', `kinds`.`code`, \' - \', `kinds`.`name`), \'\') FROM `kinds` WHERE `kinds`.`entity` LIKE \'%sdi-TipoCassa%\' ORDER BY 2 ',
				'inherit_permissions' => false,
				'list_type' => 0,
				'not_null' => false
			),
			'modalitaPagamento' => array(
				...
				'parent_from' => '`kinds` ',
				'filterers' => array(),
				'custom_query' => 'SELECT `kinds`.`code`, IF(CHAR_LENGTH(`kinds`.`code`) || CHAR_LENGTH(`kinds`.`name`), CONCAT_WS(\'\', `kinds`.`code`, \' - \', `kinds`.`name`), \'\') FROM `kinds` WHERE `kinds`.`entity` LIKE \'%sdi-ModalitaPagamento%\' ORDER BY 2 ',
				'inherit_permissions' => false,
				'list_type' => 0,
				'not_null' => false
			)
