	...
	$lookups = array(   
		...
		'companies' => array(   
			...
			'codiceDestinatario' => array(
				'parent_table' => 'codiceDestinatario',
				'parent_pk_field' => 'code',
				'parent_caption' => 'IF(CHAR_LENGTH(`codiceDestinatario`.`code`) || CHAR_LENGTH(`codiceDestinatario`.`text`), CONCAT_WS(\'\', `codiceDestinatario`.`code`, \' - \', `codiceDestinatario`.`text`), \'\')',
				'parent_from' => '`codiceDestinatario` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'regimeFiscale' => array(
				'parent_table' => 'regimeFiscale',
				'parent_pk_field' => 'code',
				'parent_caption' => 'IF(CHAR_LENGTH(`regimeFiscale`.`code`) || CHAR_LENGTH(`regimeFiscale`.`text`), CONCAT_WS(\'\', `regimeFiscale`.`code`, \' - \', `regimeFiscale`.`text`), \'\')',
				'parent_from' => '`regimeFiscale` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'tipoCassa' => array(
				'parent_table' => 'tipoCassa',
				'parent_pk_field' => 'code',
				'parent_caption' => 'IF(CHAR_LENGTH(`tipoCassa`.`code`) || CHAR_LENGTH(`tipoCassa`.`text`), CONCAT_WS(\'\', `tipoCassa`.`code`, \' - \', `tipoCassa`.`text`), \'\')',
				'parent_from' => '`tipoCassa` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
