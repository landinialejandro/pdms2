...
function companies_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field kind can't be empty */
	if($j('#kind').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Tipo", close: function(){ /* */ $j('[name=kind]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field personaFisica can't be empty */
	if(!$j('[name=personaFisica]:checked').length){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Persona Fisica", close: function(){ /* */ $j('[name=personaFisica]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
...
function creditDocument_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function electronicInvoice_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function countries_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
...
function kinds_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field entity can't be empty */
	if($j('#entity').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Entity", close: function(){ /* */ $j('[name=entity]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field code can't be empty */
	if($j('#code').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Code/prefix", close: function(){ /* */ $j('[name=code]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
...
function attributes_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
...
function mails_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function contacts_companies_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
