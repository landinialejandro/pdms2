		...
		$pcConfig = array(
			...
			'firstCashNote' => array(   
				'order' => array(   
					...
					'sortable-fields' => array(0 => '`firstCashNote`.`id`', 1 => 2, 2 => 3, 3 => '`companies3`.`companyName`', 4 => '`firstCashNote`.`operationDate`', 5 => '`firstCashNote`.`documentNumber`', 6 => 7, 7 => '`firstCashNote`.`revenue`', 8 => '`firstCashNote`.`outputs`', 9 => '`firstCashNote`.`balance`', 10 => '`companies4`.`companyName`', 11 => '`companies2`.`companyName`', 12 => 13, 13 => '`firstCashNote`.`paymentDeadLine`', 14 => 15),
					'records-per-page' => 10,
