		...
		$pcConfig = array(
			'orders' => array(   
				'kind' => array(   
					...
					'sortable-fields' => array(0 => '`orders`.`id`', 1 => '`kinds1`.`name`', 2 => 3, 3 => 4, 4 => '`orders`.`multiOrder`', 5 => 6, 6 => 7, 7 => '`companies2`.`companyName`', 8 => '`companies3`.`companyName`', 9 => 10, 10 => '`orders`.`date`', 11 => '`orders`.`dateRequired`', 12 => '`orders`.`dateShipped`', 13 => '`companies4`.`companyName`', 14 => '`orders`.`Freight`', 15 => '`orders`.`pallets`', 16 => 17, 17 => 18, 18 => '`orders`.`orderTotal`', 19 => 20, 20 => 21, 21 => '`orders`.`trust`', 22 => '`orders`.`overdraft`', 23 => '`orders`.`commisionFee`', 24 => '`orders`.`commisionRate`', 25 => '`orders`.`consigneeHour`', 26 => 27, 27 => '`orders`.`related`', 28 => 29),
					'records-per-page' => 10,
					'default-sort-by' => 0,
