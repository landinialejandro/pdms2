		...
		$pcConfig = array(
			...
			'companies' => array(   
				'kind' => array(   
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(1 => 'Kind', 3 => 'CompanyCode', 4 => 'CompanyName', 5 => 'FiscalCode', 6 => 'Vat', 7 => 'Notes', 19 => 'RIT soggettoRitenuta', 21 => 'RIT AliquotaRitenuta'),
					'display-field-names' => array(1 => 'kind', 3 => 'companyCode', 4 => 'companyName', 5 => 'fiscalCode', 6 => 'vat', 7 => 'notes', 19 => 'RIT_soggettoRitenuta', 21 => 'RIT_AliquotaRitenuta'),
					'sortable-fields' => array(0 => '`companies`.`id`', 1 => '`kinds1`.`name`', 2 => '`kinds1`.`code`', 3 => 4, 4 => 5, 5 => 6, 6 => 7, 7 => 8, 8 => '`kinds2`.`code`', 9 => '`kinds3`.`code`', 10 => '`kinds4`.`code`', 11 => '`kinds5`.`code`', 12 => 13, 13 => 14, 14 => 15, 15 => 16, 16 => 17, 17 => 18, 18 => 19, 19 => 20, 20 => 21, 21 => '`companies`.`RIT_AliquotaRitenuta`', 22 => 23),
					'records-per-page' => 10,
					'default-sort-by' => 4,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
				...
				'codiceDestinatario' => array(   
					...
					'child-primary-key' => 'id',
					'child-primary-key-index' => 0,
					'tab-label' => 'Companies <span class="hidden child-label-companies child-field-caption">(Codice Destinatario)</span>',
					'auto-close' => true,
					'table-icon' => 'resources/table_icons/factory.png',
					'display-refresh' => true,
					'display-add-new' => true,
				...
				'tipoCassa' => array(   
					...
					'child-primary-key' => 'id',
					'child-primary-key-index' => 0,
					'tab-label' => 'Companies <span class="hidden child-label-companies child-field-caption">(TipoCassa)</span>',
					'auto-close' => true,
					'table-icon' => 'resources/table_icons/factory.png',
					'display-refresh' => true,
					'display-add-new' => true,
				...
				'modalitaPagamento' => array(   
					...
					'child-primary-key' => 'id',
					'child-primary-key-index' => 0,
					'tab-label' => 'Companies <span class="hidden child-label-companies child-field-caption">(ModalitaPagamento)</span>',
					'auto-close' => true,
					'table-icon' => 'resources/table_icons/factory.png',
					'display-refresh' => true,
					'display-add-new' => true,
			...
			'addresses' => array(   
				'kind' => array(   
					...
					'child-primary-key' => 'id',
					'child-primary-key-index' => 0,
					'tab-label' => 'Addresses <span class="hidden child-label-addresses child-field-caption">(Kind)</span>',
					'auto-close' => true,
					'table-icon' => 'resources/table_icons/mail_box.png',
					'display-refresh' => true,
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(1 => 'Kind', 2 => 'Address', 3 => 'HouseNumber', 4 => 'Country Code', 5 => 'Country Name', 6 => 'Town', 7 => 'PostalCode', 8 => 'District', 12 => 'Default', 13 => 'Ship'),
			...
			'mails' => array(   
				'kind' => array(   
					...
					'child-primary-key' => 'id',
					'child-primary-key-index' => 0,
					'tab-label' => 'Mails <span class="hidden child-label-mails child-field-caption">(Kind)</span>',
					'auto-close' => true,
