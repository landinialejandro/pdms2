...
function orders_insert(){
	...
	$data['divisa'] = makeSafe($_REQUEST['divisa']);
		if($data['divisa'] == empty_lookup_value){ $data['divisa'] = ''; }
	$data['causale'] = makeSafe($_REQUEST['causale']);
		if($data['causale'] == empty_lookup_value){ $data['causale'] = ''; }
	...
	$data['dateShipped'] = intval($_REQUEST['dateShippedYear']) . '-' . intval($_REQUEST['dateShippedMonth']) . '-' . intval($_REQUEST['dateShippedDay']);
	$data['dateShipped'] = parseMySQLDate($data['dateShipped'], '<%%creationDate%%>');
	...
	$data['importoSconto'] = makeSafe($_REQUEST['importoSconto']);
		if($data['importoSconto'] == empty_lookup_value){ $data['importoSconto'] = ''; }
	$data['orderTotal'] = makeSafe($_REQUEST['orderTotal']);
		if($data['orderTotal'] == empty_lookup_value){ $data['orderTotal'] = ''; }
	$data['RIT_importoRitenuta'] = makeSafe($_REQUEST['RIT_importoRitenuta']);
		if($data['RIT_importoRitenuta'] == empty_lookup_value){ $data['RIT_importoRitenuta'] = ''; }
	...
	if($data['kind']== ''){
		echo StyleSheet() . "\n\n<div class=\"alert alert-danger\">" . $Translation['error:'] . " 'Tipo ordine': " . $Translation['field not null'] . '<br><br>';
		echo '<a href="" onclick="history.go(-1); return false;">'.$Translation['< back'].'</a></div>';
		exit;
	}
	if($data['company']== ''){
		echo StyleSheet() . "\n\n<div class=\"alert alert-danger\">" . $Translation['error:'] . " 'Azienda': " . $Translation['field not null'] . '<br><br>';
		echo '<a href="" onclick="history.go(-1); return false;">'.$Translation['< back'].'</a></div>';
		exit;
	}
	if($data['typeDoc']== ''){
	...
	if($data['divisa'] == '') $data['divisa'] = "EUR";
	if($data['divisa']== ''){
		echo StyleSheet() . "\n\n<div class=\"alert alert-danger\">" . $Translation['error:'] . " 'Divisa': " . $Translation['field not null'] . '<br><br>';
		echo '<a href="" onclick="history.go(-1); return false;">'.$Translation['< back'].'</a></div>';
		exit;
	}
	if($data['causale'] == '') $data['causale'] = "VENDITA";
	if($data['causale']== ''){
		echo StyleSheet() . "\n\n<div class=\"alert alert-danger\">" . $Translation['error:'] . " 'Causale': " . $Translation['field not null'] . '<br><br>';
		echo '<a href="" onclick="history.go(-1); return false;">'.$Translation['< back'].'</a></div>';
		exit;
	}
	...
	sql('insert into `orders` set       `kind`=' . (($data['kind'] !== '' && $data['kind'] !== NULL) ? "'{$data['kind']}'" : 'NULL') . ', `company`=' . (($data['company'] !== '' && $data['company'] !== NULL) ? "'{$data['company']}'" : 'NULL') . ', `typeDoc`=' . (($data['typeDoc'] !== '' && $data['typeDoc'] !== NULL) ? "'{$data['typeDoc']}'" : 'NULL') . ', `multiOrder`=' . (($data['multiOrder'] !== '' && $data['multiOrder'] !== NULL) ? "'{$data['multiOrder']}'" : 'NULL') . ', `divisa`=' . (($data['divisa'] !== '' && $data['divisa'] !== NULL) ? "'{$data['divisa']}'" : 'NULL') . ', `causale`=' . (($data['causale'] !== '' && $data['causale'] !== NULL) ? "'{$data['causale']}'" : 'NULL') . ', `customer`=' . (($data['customer'] !== '' && $data['customer'] !== NULL) ? "'{$data['customer']}'" : 'NULL') . ', `supplier`=' . (($data['supplier'] !== '' && $data['supplier'] !== NULL) ? "'{$data['supplier']}'" : 'NULL') . ', `employee`=' . "'{$data['employee']}'" . ', `date`=' . "'{$data['date']}'" . ', `dateRequired`=' . (($data['dateRequired'] !== '' && $data['dateRequired'] !== NULL) ? "'{$data['dateRequired']}'" : 'NULL') . ', `dateShipped`=' . (($data['dateShipped'] !== '' && $data['dateShipped'] !== NULL) ? "'{$data['dateShipped']}'" : 'NULL') . ', `shipVia`=' . (($data['shipVia'] !== '' && $data['shipVia'] !== NULL) ? "'{$data['shipVia']}'" : 'NULL') . ', `Freight`=' . (($data['Freight'] !== '' && $data['Freight'] !== NULL) ? "'{$data['Freight']}'" : 'NULL') . ', `pallets`=' . (($data['pallets'] !== '' && $data['pallets'] !== NULL) ? "'{$data['pallets']}'" : 'NULL') . ', `licencePlate`=' . (($data['licencePlate'] !== '' && $data['licencePlate'] !== NULL) ? "'{$data['licencePlate']}'" : 'NULL') . ', `importoSconto`=' . (($data['importoSconto'] !== '' && $data['importoSconto'] !== NULL) ? "'{$data['importoSconto']}'" : 'NULL') . ', `orderTotal`=' . (($data['orderTotal'] !== '' && $data['orderTotal'] !== NULL) ? "'{$data['orderTotal']}'" : 'NULL') . ', `RIT_importoRitenuta`=' . (($data['RIT_importoRitenuta'] !== '' && $data['RIT_importoRitenuta'] !== NULL) ? "'{$data['RIT_importoRitenuta']}'" : 'NULL') . ', `cashCredit`=' . (($data['cashCredit'] !== '' && $data['cashCredit'] !== NULL) ? "'{$data['cashCredit']}'" : 'NULL') . ', `commisionFee`=' . (($data['commisionFee'] !== '' && $data['commisionFee'] !== NULL) ? "'{$data['commisionFee']}'" : 'NULL') . ', `commisionRate`=' . (($data['commisionRate'] !== '' && $data['commisionRate'] !== NULL) ? "'{$data['commisionRate']}'" : 'NULL') . ', `consigneeHour`=' . (($data['consigneeHour'] !== '' && $data['consigneeHour'] !== NULL) ? "'{$data['consigneeHour']}'" : 'NULL') . ', `consigneePlace`=' . (($data['consigneePlace'] !== '' && $data['consigneePlace'] !== NULL) ? "'{$data['consigneePlace']}'" : 'NULL') . ', `related`=' . (($data['related'] !== '' && $data['related'] !== NULL) ? "'{$data['related']}'" : 'NULL') . ', `document`=' . (($data['document'] !== '' && $data['document'] !== NULL) ? "'{$data['document']}'" : 'NULL'), $o);
	if($o['error']!=''){
		echo $o['error'];
...
function orders_delete($selected_id, $AllowDeleteOfParents=false, $skipChecks=false){
	...
	$res = sql("select `id` from `orders` where `id`='$selected_id'", $eo);
	$id = db_fetch_row($res);
	$rires = sql("select count(1) from `_ordersSummary` where `related`='".addslashes($id[0])."'", $eo);
	$rirow = db_fetch_row($rires);
	if($rirow[0] && !$AllowDeleteOfParents && !$skipChecks){
		$RetMsg = $Translation["couldn't delete"];
		$RetMsg = str_replace("<RelatedRecords>", $rirow[0], $RetMsg);
...
function orders_update($selected_id){
	...
	$o=array('silentErrors' => true);
	sql('update `orders` set       `kind`=' . (($data['kind'] !== '' && $data['kind'] !== NULL) ? "'{$data['kind']}'" : 'NULL') . ', `company`=' . (($data['company'] !== '' && $data['company'] !== NULL) ? "'{$data['company']}'" : 'NULL') . ', `typeDoc`=' . (($data['typeDoc'] !== '' && $data['typeDoc'] !== NULL) ? "'{$data['typeDoc']}'" : 'NULL') . ', `multiOrder`=' . (($data['multiOrder'] !== '' && $data['multiOrder'] !== NULL) ? "'{$data['multiOrder']}'" : 'NULL') . ', `divisa`=' . (($data['divisa'] !== '' && $data['divisa'] !== NULL) ? "'{$data['divisa']}'" : 'NULL') . ', `causale`=' . (($data['causale'] !== '' && $data['causale'] !== NULL) ? "'{$data['causale']}'" : 'NULL') . ', `customer`=' . (($data['customer'] !== '' && $data['customer'] !== NULL) ? "'{$data['customer']}'" : 'NULL') . ', `supplier`=' . (($data['supplier'] !== '' && $data['supplier'] !== NULL) ? "'{$data['supplier']}'" : 'NULL') . ', `date`=`date`' . ', `dateRequired`=' . (($data['dateRequired'] !== '' && $data['dateRequired'] !== NULL) ? "'{$data['dateRequired']}'" : 'NULL') . ', `dateShipped`=' . (($data['dateShipped'] !== '' && $data['dateShipped'] !== NULL) ? "'{$data['dateShipped']}'" : 'NULL') . ', `shipVia`=' . (($data['shipVia'] !== '' && $data['shipVia'] !== NULL) ? "'{$data['shipVia']}'" : 'NULL') . ', `Freight`=' . (($data['Freight'] !== '' && $data['Freight'] !== NULL) ? "'{$data['Freight']}'" : 'NULL') . ', `pallets`=' . (($data['pallets'] !== '' && $data['pallets'] !== NULL) ? "'{$data['pallets']}'" : 'NULL') . ', `licencePlate`=' . (($data['licencePlate'] !== '' && $data['licencePlate'] !== NULL) ? "'{$data['licencePlate']}'" : 'NULL') . ', `importoSconto`=' . (($data['importoSconto'] !== '' && $data['importoSconto'] !== NULL) ? "'{$data['importoSconto']}'" : 'NULL') . ', `orderTotal`=' . (($data['orderTotal'] !== '' && $data['orderTotal'] !== NULL) ? "'{$data['orderTotal']}'" : 'NULL') . ', `RIT_importoRitenuta`=' . (($data['RIT_importoRitenuta'] !== '' && $data['RIT_importoRitenuta'] !== NULL) ? "'{$data['RIT_importoRitenuta']}'" : 'NULL') . ', `cashCredit`=' . (($data['cashCredit'] !== '' && $data['cashCredit'] !== NULL) ? "'{$data['cashCredit']}'" : 'NULL') . ', `commisionFee`=' . (($data['commisionFee'] !== '' && $data['commisionFee'] !== NULL) ? "'{$data['commisionFee']}'" : 'NULL') . ', `commisionRate`=' . (($data['commisionRate'] !== '' && $data['commisionRate'] !== NULL) ? "'{$data['commisionRate']}'" : 'NULL') . ', `consigneeHour`=' . (($data['consigneeHour'] !== '' && $data['consigneeHour'] !== NULL) ? "'{$data['consigneeHour']}'" : 'NULL') . ', `consigneePlace`=' . (($data['consigneePlace'] !== '' && $data['consigneePlace'] !== NULL) ? "'{$data['consigneePlace']}'" : 'NULL') . ', `related`=' . (($data['related'] !== '' && $data['related'] !== NULL) ? "'{$data['related']}'" : 'NULL') . ', `document`=' . (($data['document'] !== '' && $data['document'] !== NULL) ? "'{$data['document']}'" : 'NULL') . " where `id`='".makeSafe($selected_id)."'", $o);
	if($o['error']!=''){
		echo $o['error'];
...
function orders_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = ''){
	...
	// combobox: divisa
	$combo_divisa = new Combo;
	$combo_divisa->ListType = 0;
	$combo_divisa->MultipleSeparator = ', ';
	$combo_divisa->ListBoxHeight = 10;
	$combo_divisa->RadiosPerLine = 1;
	if(is_file(dirname(__FILE__).'/hooks/orders.divisa.csv')){
		$divisa_data = addslashes(implode('', @file(dirname(__FILE__).'/hooks/orders.divisa.csv')));
		$combo_divisa->ListItem = explode('||', entitiesToUTF8(convertLegacyOptions($divisa_data)));
		$combo_divisa->ListData = $combo_divisa->ListItem;
	}else{
		$combo_divisa->ListItem = explode('||', entitiesToUTF8(convertLegacyOptions("EUR;;USD;;GBP;;CZK")));
		$combo_divisa->ListData = $combo_divisa->ListItem;
	}
	$combo_divisa->SelectName = 'divisa';
	$combo_divisa->AllowNull = false;
	// combobox: causale
	$combo_causale = new Combo;
	$combo_causale->ListType = 0;
	$combo_causale->MultipleSeparator = ', ';
	$combo_causale->ListBoxHeight = 10;
	$combo_causale->RadiosPerLine = 1;
	if(is_file(dirname(__FILE__).'/hooks/orders.causale.csv')){
		$causale_data = addslashes(implode('', @file(dirname(__FILE__).'/hooks/orders.causale.csv')));
		$combo_causale->ListItem = explode('||', entitiesToUTF8(convertLegacyOptions($causale_data)));
		$combo_causale->ListData = $combo_causale->ListItem;
	}else{
		$combo_causale->ListItem = explode('||', entitiesToUTF8(convertLegacyOptions("C/LAVORAZIONE;;C/RIPARAZIONE;;C/VISIONE;;CESSIONE;;CONSEGNA C/TERZI;;LAVORAZIONE;;OMAGGIO;;RESO;;RESO C/LAVORAZIONE;;RESO C/RIPARAZIONE;;RESO C/VISIONE;;RESO SCARTO INUTILIZZABILE;;RIPARAZIONE;;TENTATA VENDITA;;VENDITA")));
		$combo_causale->ListData = $combo_causale->ListItem;
	}
	$combo_causale->SelectName = 'causale';
	$combo_causale->AllowNull = false;
	// combobox: customer
	...
	// combobox: dateRequired
	$combo_dateRequired = new DateCombo;
	$combo_dateRequired->DateFormat = "dmy";
	$combo_dateRequired->MinYear = 1900;
	$combo_dateRequired->MaxYear = 2100;
	$combo_dateRequired->DefaultDate = parseMySQLDate('<%%creationDate%%>', '<%%creationDate%%>');
	$combo_dateRequired->MonthNames = $Translation['month names'];
	$combo_dateRequired->NamePrefix = 'dateRequired';
	// combobox: dateShipped
	$combo_dateShipped = new DateCombo;
	$combo_dateShipped->DateFormat = "dmy";
	$combo_dateShipped->MinYear = 1900;
	$combo_dateShipped->MaxYear = 2100;
	$combo_dateShipped->DefaultDate = parseMySQLDate('<%%creationDate%%>', '<%%creationDate%%>');
	$combo_dateShipped->MonthNames = $Translation['month names'];
	$combo_dateShipped->NamePrefix = 'dateShipped';
	// combobox: shipVia
	...
	if($selected_id){
		...
		$combo_divisa->SelectedData = $row['divisa'];
		...
		$combo_divisa->SelectedText = ( $_REQUEST['FilterField'][1]=='6' && $_REQUEST['FilterOperator'][1]=='<=>' ? (get_magic_quotes_gpc() ? stripslashes($_REQUEST['FilterValue'][1]) : $_REQUEST['FilterValue'][1]) : "EUR");
	...
	if(($selected_id && !$AllowUpdate && !$AllowInsert) || (!$selected_id && !$AllowInsert)){
		...
		$jsReadOnly .= "\tjQuery('#divisa').replaceWith('<div class=\"form-control-static\" id=\"divisa\">' + (jQuery('#divisa').val() || '') + '</div>'); jQuery('#divisa-multi-selection-help').hide();\n";
		$jsReadOnly .= "\tjQuery('#causale').replaceWith('<div class=\"form-control-static\" id=\"causale\">' + (jQuery('#causale').val() || '') + '</div>'); jQuery('#causale-multi-selection-help').hide();\n";
		...
		$jsReadOnly .= "\tjQuery('#dateRequired').prop('readonly', true);\n";
		$jsReadOnly .= "\tjQuery('#dateRequiredDay, #dateRequiredMonth, #dateRequiredYear').prop('disabled', true).css({ color: '#555', backgroundColor: '#fff' });\n";
		$jsReadOnly .= "\tjQuery('#dateShipped').prop('readonly', true);\n";
		$jsReadOnly .= "\tjQuery('#dateShippedDay, #dateShippedMonth, #dateShippedYear').prop('disabled', true).css({ color: '#555', backgroundColor: '#fff' });\n";
		...
		$jsReadOnly .= "\tjQuery('#importoSconto').replaceWith('<div class=\"form-control-static\" id=\"importoSconto\">' + (jQuery('#importoSconto').val() || '') + '</div>');\n";
		$jsReadOnly .= "\tjQuery('#orderTotal').replaceWith('<div class=\"form-control-static\" id=\"orderTotal\">' + (jQuery('#orderTotal').val() || '') + '</div>');\n";
		$jsReadOnly .= "\tjQuery('#RIT_importoRitenuta').replaceWith('<div class=\"form-control-static\" id=\"RIT_importoRitenuta\">' + (jQuery('#RIT_importoRitenuta').val() || '') + '</div>');\n";
		...
		$jsReadOnly .= "\tjQuery('#commisionRate').replaceWith('<div class=\"form-control-static\" id=\"commisionRate\">' + (jQuery('#commisionRate').val() || '') + '</div>');\n";
		...
		$jsEditable .= "\tjQuery('#consigneeHour').addClass('always_shown').parents('.input-group').datetimepicker({ toolbarPlacement: 'top', sideBySide: true, showClear: true, showTodayButton: true, showClose: true, icons: { close: 'glyphicon glyphicon-ok' }, format: AppGini.datetimeFormat('dt') {$locale} });";
	...
	$templateCode = str_replace('<%%COMBO(divisa)%%>', $combo_divisa->HTML, $templateCode);
	$templateCode = str_replace('<%%COMBOTEXT(divisa)%%>', $combo_divisa->SelectedData, $templateCode);
	$templateCode = str_replace('<%%COMBO(causale)%%>', $combo_causale->HTML, $templateCode);
	$templateCode = str_replace('<%%COMBOTEXT(causale)%%>', $combo_causale->SelectedData, $templateCode);
	...
	$templateCode = str_replace('<%%COMBOTEXT(dateRequired)%%>', $combo_dateRequired->GetHTML(true), $templateCode);
	$templateCode = str_replace('<%%COMBO(dateShipped)%%>', ($selected_id && !$arrPerm[3] ? '<div class="form-control-static">' . $combo_dateShipped->GetHTML(true) . '</div>' : $combo_dateShipped->GetHTML()), $templateCode);
	$templateCode = str_replace('<%%COMBOTEXT(dateShipped)%%>', $combo_dateShipped->GetHTML(true), $templateCode);
	...
	$templateCode = str_replace('<%%UPLOADFILE(divisa)%%>', '', $templateCode);
	$templateCode = str_replace('<%%UPLOADFILE(causale)%%>', '', $templateCode);
	...
	$templateCode = str_replace('<%%UPLOADFILE(dateRequired)%%>', '', $templateCode);
	$templateCode = str_replace('<%%UPLOADFILE(dateShipped)%%>', '', $templateCode);
	...
	$templateCode = str_replace('<%%UPLOADFILE(importoSconto)%%>', '', $templateCode);
	$templateCode = str_replace('<%%UPLOADFILE(orderTotal)%%>', '', $templateCode);
	$templateCode = str_replace('<%%UPLOADFILE(RIT_importoRitenuta)%%>', '', $templateCode);
	...
	if($selected_id){
		...
		if( $dvprint) $templateCode = str_replace('<%%VALUE(divisa)%%>', safe_html($urow['divisa']), $templateCode);
		if(!$dvprint) $templateCode = str_replace('<%%VALUE(divisa)%%>', html_attr($row['divisa']), $templateCode);
		$templateCode = str_replace('<%%URLVALUE(divisa)%%>', urlencode($urow['divisa']), $templateCode);
		if( $dvprint) $templateCode = str_replace('<%%VALUE(causale)%%>', safe_html($urow['causale']), $templateCode);
		if(!$dvprint) $templateCode = str_replace('<%%VALUE(causale)%%>', html_attr($row['causale']), $templateCode);
		$templateCode = str_replace('<%%URLVALUE(causale)%%>', urlencode($urow['causale']), $templateCode);
		...
		$templateCode = str_replace('<%%VALUE(employee)%%>', safe_html($urow['employee']), $templateCode);
		...
		$templateCode = str_replace('<%%VALUE(dateRequired)%%>', @date('d/m/Y', @strtotime(html_attr($row['dateRequired']))), $templateCode);
		$templateCode = str_replace('<%%URLVALUE(dateRequired)%%>', urlencode(@date('d/m/Y', @strtotime(html_attr($urow['dateRequired'])))), $templateCode);
		$templateCode = str_replace('<%%VALUE(dateShipped)%%>', @date('d/m/Y', @strtotime(html_attr($row['dateShipped']))), $templateCode);
		$templateCode = str_replace('<%%URLVALUE(dateShipped)%%>', urlencode(@date('d/m/Y', @strtotime(html_attr($urow['dateShipped'])))), $templateCode);
		...
		if( $dvprint) $templateCode = str_replace('<%%VALUE(importoSconto)%%>', safe_html($urow['importoSconto']), $templateCode);
		if(!$dvprint) $templateCode = str_replace('<%%VALUE(importoSconto)%%>', html_attr($row['importoSconto']), $templateCode);
		$templateCode = str_replace('<%%URLVALUE(importoSconto)%%>', urlencode($urow['importoSconto']), $templateCode);
		...
		if( $dvprint) $templateCode = str_replace('<%%VALUE(RIT_importoRitenuta)%%>', safe_html($urow['RIT_importoRitenuta']), $templateCode);
		if(!$dvprint) $templateCode = str_replace('<%%VALUE(RIT_importoRitenuta)%%>', html_attr($row['RIT_importoRitenuta']), $templateCode);
		$templateCode = str_replace('<%%URLVALUE(RIT_importoRitenuta)%%>', urlencode($urow['RIT_importoRitenuta']), $templateCode);
		...
		$templateCode = str_replace('<%%VALUE(divisa)%%>', 'EUR', $templateCode);
		$templateCode = str_replace('<%%URLVALUE(divisa)%%>', urlencode('EUR'), $templateCode);
		$templateCode = str_replace('<%%VALUE(causale)%%>', 'VENDITA', $templateCode);
		$templateCode = str_replace('<%%URLVALUE(causale)%%>', urlencode('VENDITA'), $templateCode);
		...
		$templateCode = str_replace('<%%URLVALUE(dateRequired)%%>', urlencode('<%%creationDate%%>'), $templateCode);
		$templateCode = str_replace('<%%VALUE(dateShipped)%%>', '<%%creationDate%%>', $templateCode);
		$templateCode = str_replace('<%%URLVALUE(dateShipped)%%>', urlencode('<%%creationDate%%>'), $templateCode);
