<?php
	...
	*/
	 ...
	 *     $data['kind'], $data['company'], $data['typeDoc'], $data['multiOrder'], $data['customer'], $data['date'], $data['shippedDate'], $data['shipVia'], $data['Freight'], $data['pallets'], $data['licencePlate'], $data['orderTotal'], $data['cashCredit'], $data['trust'], $data['overdraft'], $data['commisionFee'], $data['consigneeHour'], $data['consigneePlace']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['kind'], $data['progressiveNr'], $data['trasmissionFor'], $data['consigneeID'], $data['company'], $data['typeDoc'], $data['multiOrder'], $data['customer'], $data['employee'], $data['date'], $data['requiredDate'], $data['shippedDate'], $data['shipVia'], $data['Freight'], $data['pallets'], $data['licencePlate'], $data['orderTotal'], $data['cashCredit'], $data['trust'], $data['overdraft'], $data['commisionFee'], $data['consigneeHour'], $data['consigneePlace']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['kind'], $data['company'], $data['typeDoc'], $data['multiOrder'], $data['customer'], $data['date'], $data['shippedDate'], $data['shipVia'], $data['Freight'], $data['pallets'], $data['licencePlate'], $data['orderTotal'], $data['cashCredit'], $data['trust'], $data['overdraft'], $data['commisionFee'], $data['consigneeHour'], $data['consigneePlace']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['kind'], $data['progressiveNr'], $data['trasmissionFor'], $data['consigneeID'], $data['company'], $data['typeDoc'], $data['multiOrder'], $data['customer'], $data['employee'], $data['date'], $data['requiredDate'], $data['shippedDate'], $data['shipVia'], $data['Freight'], $data['pallets'], $data['licencePlate'], $data['orderTotal'], $data['cashCredit'], $data['trust'], $data['overdraft'], $data['commisionFee'], $data['consigneeHour'], $data['consigneePlace']
