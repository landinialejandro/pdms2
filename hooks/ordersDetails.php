<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'ordersDetails' table. 
	...
	*/
	 ...
	 *     $data['manufactureDate'], $data['sellDate'], $data['productCode'], $data['ProductID'], $data['packages'], $data['noSell'], $data['Quantity'], $data['QuantityReal'], $data['UnitPrice'], $data['Discount'], $data['averagePrice'], $data['averageWeight'], $data['commission'], $data['return'], $data['supplierCode']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['idCompany'], $data['manufactureDate'], $data['sellDate'], $data['expiryDate'], $data['daysToExpiry'], $data['codebar'], $data['UM'], $data['productCode'], $data['batch'], $data['ProductID'], $data['packages'], $data['noSell'], $data['Quantity'], $data['QuantityReal'], $data['UnitPrice'], $data['Subtotal'], $data['taxes'], $data['Discount'], $data['LineTotal'], $data['section'], $data['transaction_type'], $data['skBatches'], $data['averagePrice'], $data['averageWeight'], $data['commission'], $data['return'], $data['supplierCode']
