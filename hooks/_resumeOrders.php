<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on '_resumeOrders' table. 
	...
	*/
	 ...
	 *     $data['kind'], $data['company'], $data['typedoc'], $data['cusotmer'], $data['TOT'], $data['MONTH'], $data['YEAR'], $data['DOCs'], $data['realted']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['kind'], $data['company'], $data['typedoc'], $data['cusotmer'], $data['TOT'], $data['MONTH'], $data['YEAR'], $data['DOCs'], $data['realted'], $data['id']
