<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'GPSTrackingSystem' table. 
	...
	*/
	...
	function GPSTrackingSystem_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function GPSTrackingSystem_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function GPSTrackingSystem_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function GPSTrackingSystem_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function GPSTrackingSystem_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function GPSTrackingSystem_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function GPSTrackingSystem_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function GPSTrackingSystem_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function GPSTrackingSystem_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function GPSTrackingSystem_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function GPSTrackingSystem_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function GPSTrackingSystem_batch_actions(&$args){
