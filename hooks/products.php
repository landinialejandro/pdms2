<?php
	...
	*/
	 ...
	 *     $data['codebar'], $data['productCode'], $data['ProductName'], $data['tax'], $data['increment'], $data['CategoryID'], $data['UM'], $data['tare'], $data['UnitPrice'], $data['sellPrice'], $data['Discontinued'], $data['manufactured_date'], $data['note']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['codebar'], $data['productCode'], $data['ProductName'], $data['tax'], $data['increment'], $data['CategoryID'], $data['UM'], $data['tare'], $data['QuantityPerUnit'], $data['UnitPrice'], $data['sellPrice'], $data['UnitsInStock'], $data['UnitsOnOrder'], $data['ReorderLevel'], $data['balance'], $data['Discontinued'], $data['manufactured_date'], $data['expiry_date'], $data['note']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['codebar'], $data['productCode'], $data['ProductName'], $data['tax'], $data['increment'], $data['CategoryID'], $data['UM'], $data['tare'], $data['UnitPrice'], $data['sellPrice'], $data['Discontinued'], $data['manufactured_date'], $data['note']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['codebar'], $data['productCode'], $data['ProductName'], $data['tax'], $data['increment'], $data['CategoryID'], $data['UM'], $data['tare'], $data['QuantityPerUnit'], $data['UnitPrice'], $data['sellPrice'], $data['UnitsInStock'], $data['UnitsOnOrder'], $data['ReorderLevel'], $data['balance'], $data['Discontinued'], $data['manufactured_date'], $data['expiry_date'], $data['note']
