...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="_resumeOrders_view.php" style="text-decoration: none; color: inherit;">
										Resume Orders Filters</a>
			</h1></div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="col-md-8 col-lg-6 vspacer-md">
			...
			<input type="hidden" id="lookupoperator_1" name="FilterOperator[1]" value="equal-to">
			<input type="hidden" id="filterfield_1" name="FilterValue[1]" value="<?php echo htmlspecialchars($FilterValue[1]); ?>" size="3">
		</div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Company</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Company</label></div>
		...
		<div class="col-md-8 col-lg-6 vspacer-md">
			...
			<input type="hidden" id="lookupoperator_2" name="FilterOperator[2]" value="equal-to">
			<input type="hidden" id="filterfield_2" name="FilterValue[2]" value="<?php echo htmlspecialchars($FilterValue[2]); ?>" size="3">
		</div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Typedoc</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Typedoc</label></div>
