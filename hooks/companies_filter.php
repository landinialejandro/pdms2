...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="companies_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/factory.png"> 					Companies Filters</a>
			</h1></div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">CompanyCode</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">CompanyCode</label></div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">CompanyName</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">CompanyName</label></div>
