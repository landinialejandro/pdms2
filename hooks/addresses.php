<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'addresses' table. 
	...
	*/
	...
	function addresses_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function addresses_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function addresses_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['kind'], $data['address'], $data['houseNumber'], $data['country'], $data['town'], $data['postalCode'], $data['district'], $data['map']
	...
	*/
	...
	function addresses_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['kind'], $data['address'], $data['houseNumber'], $data['country'], $data['town'], $data['postalCode'], $data['district'], $data['contact'], $data['company'], $data['map']
	...
	*/
	...
	function addresses_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['kind'], $data['address'], $data['houseNumber'], $data['country'], $data['town'], $data['postalCode'], $data['district'], $data['map']
	...
	*/
	...
	function addresses_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['kind'], $data['address'], $data['houseNumber'], $data['country'], $data['town'], $data['postalCode'], $data['district'], $data['contact'], $data['company'], $data['map']
	...
	*/
	...
	function addresses_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function addresses_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function addresses_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function addresses_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function addresses_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function addresses_batch_actions(&$args){
