<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'attachments' table. 
	...
	*/
	...
	function attachments_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function attachments_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['name'], $data['file'], $data['thumbUse']
	...
	*/
	...
	function attachments_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['name'], $data['file'], $data['contact'], $data['company'], $data['thumbUse']
	...
	*/
	...
	function attachments_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['name'], $data['file'], $data['thumbUse']
	...
	*/
	...
	function attachments_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['name'], $data['file'], $data['contact'], $data['company'], $data['thumbUse']
	...
	*/
	...
	function attachments_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function attachments_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function attachments_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function attachments_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function attachments_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function attachments_batch_actions(&$args){
